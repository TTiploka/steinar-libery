export default function Login() {
    ...
    <article className="text-white flex text-left my-20 p-2 mx-auto w-3/5 h-auto">
        <div className="border w-1/3 py-5 px-5 rounded-l-md bg-gray-900">
            ...
            <input className="w-full rounded-sm h-10 text-xl mb-5" type="text" placeholder="Luca" />
            <p className="text-sm">Password</p>
            <input className="w-full rounded-sm h-10 text-xl" type="text" placeholder="Password" />
