...
export default function App() {
  ...
  <h3>Contactenos</h3>
  <img className='w-6 h-6 rounded-lg ml-10' src='src/icon_f.png'></img>
  <img className='w-6 h-6 rounded-lg ml-3' src='src/icon_t.png'></img>
  <img className='w-6 h-6 rounded-lg ml-3' src='src/icon_w.png'></img>
</footer> 
  </>
  )
}
